...
describe('Int: Directorate -> Stats -> All', () => {
  ...
  it('should generate stats.services.all.risk_high using getServices({ risk: "high" }) method', () => {
    ...
    expect(directorate.stats.services.all.compliant).to.eql(0, 'stats.services.all.compliant')
    expect(directorate.stats.services.all.not_compliant).to.eql(1, 'stats.services.all.not_compliant')
    expect(directorate.stats.services.all.risk_very_high).to.eql(0, 'stats.services.all.risk_very_high')
  ...
  it('should generate stats.services.all.risk_medium using getServices({ risk: "medium" }) method', () => {
    ...
    expect(directorate.stats.services.all.not_compliant).to.eql(1, 'stats.services.all.not_compliant')
    expect(directorate.stats.services.all.risk_very_high).to.eql(0, 'stats.services.all.risk_very_high')
    expect(directorate.stats.services.all.risk_high).to.eql(0, 'stats.services.all.risk_high')
  ...
  it('should generate stats.services.all.critical using getServices({ critical: "true" }) method', () => {
    ...
    expect(directorate.stats.services.all.risk_very_high).to.eql(1, 'stats.services.all.risk_very_high')
    expect(directorate.stats.services.all.risk_high).to.eql(0, 'stats.services.all.risk_high')
    expect(directorate.stats.services.all.risk_medium).to.eql(0, 'stats.services.all.risk_medium')
  ...
  it('should generate stats.services.all.not_critical using getServices({ critical: "false" }) method', () => {
    ...
    expect(directorate.stats.services.all.risk_high).to.eql(0, 'stats.services.all.risk_high')
    expect(directorate.stats.services.all.risk_medium).to.eql(0, 'stats.services.all.risk_medium')
    expect(directorate.stats.services.all.critical).to.eql(0, 'stats.services.all.critical')
  ...
  it('should generate stats.services.all.not_sunsetting using getServices({ sunsetting: "false" }) method', () => {
    ...
    expect(directorate.stats.services.all.risk_medium).to.eql(0, 'stats.services.all.risk_medium')
    expect(directorate.stats.services.all.critical).to.eql(0, 'stats.services.all.critical')
    expect(directorate.stats.services.all.sunsetting).to.eql(0, 'stats.services.all.sunsetting')
  ...
  it('should generate stats.services.all.no_plans using getServices({ plans: "false" }) method', () => {
    ...
    expect(directorate.stats.services.all.critical).to.eql(0, 'stats.services.all.critical')
    expect(directorate.stats.services.all.sunsetting).to.eql(0, 'stats.services.all.sunsetting')
    expect(directorate.stats.services.all.plans).to.eql(0, 'stats.services.all.plans')
  })
})
