...
describe('Int: Org -> Stats -> Rates', () => {
  it('should generate stats.rates.true.total as a percentage', () => {
    ...
    service2.save()
    expect(org.stats.rates.true_compliance.total).to.eql(50, 'stats.rates.true.total')
  })
  ...
  it('should generate stats.rates.true.citizen as a percentage', () => {
    ...
    const service2 = new Service(paramsService2)
    service2.save()
    expect(org.stats.rates.true_compliance.citizen).to.eql(100, 'stats.rates.true.citizen')
  })
  ...
  it('should generate stats.rates.true.staff as a percentage', () => {
    ...
    const service2 = new Service(paramsService2)
    service2.save()
    expect(org.stats.rates.true_compliance.staff).to.eql(100, 'stats.rates.true.staff')
  })
  ...
  it('should generate stats.rates.adjusted.all as a percentage', () => {
    ...
    const service2 = new Service(paramsService2)
    service2.save()
    expect(org.stats.rates.adjusted_compliance.total).to.eql(100, 'stats.rates.adjusted.total')
  })
  it('should generate stats.rates.adjusted.citizen as a percentage', () => {
    ...
    const service2 = new Service(paramsService2)
    service2.save()
    expect(org.stats.rates.adjusted_compliance.citizen).to.eql(100, 'stats.rates.adjusted.citizen')
  })
  it('should generate stats.rates.adjusted.citizen as a percentage', () => {
    const orgParams = cloneDeep(testData.directorate)
    const org = new Org(orgParams)
    ...
    const service2 = new Service(paramsService2)
    service2.save()
    expect(org.stats.rates.adjusted_compliance.staff).to.eql(100, 'stats.rates.adjusted.staff')
  })
})
