...
describe('Routes: Sitemap', () => {
  it('should have a get function: pages/sitemap', () => {
    const router = require(path.resolve('src', 'templates', 'report', 'pages', 'sitemap', 'routes'))
  ...
  it('should render a template', () => {
    ...
    cleanDataModel()
    buildDataModel('test')
    const { get } = require(path.resolve('src', 'templates', 'report', 'pages', 'sitemap', 'functions'))
    const req = {}
    const res = { send: (html) => { } }
    sinon.spy(res, 'send')
