...
describe('Routes: Accessibility Statement', () => {
  it('should have a get function: pages/accessibility-statement', () => {
    const router = require(path.resolve('src', 'templates', 'report', 'pages', 'accessibility-statement', 'routes'))
  ...
  it('should render a template', () => {
    ...
    cleanDataModel()
    buildDataModel('test')
    const { get } = require(path.resolve('src', 'templates', 'report', 'pages', 'accessibility-statement', 'functions'))
    const req = {}
    const res = { send: (html) => { } }
    sinon.spy(res, 'send')
