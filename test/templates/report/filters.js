...
describe('View: Filters', () => {
  it('should render: pages/filters/no-plans-for-compliance', () => {
    ...
    const getHTML = require('../../../src/templates/report/pages/filters/no-plans-for-compliance/build-html')
    const HTML = getHTML()
  ...
  it('should render: pages/filters/compliant-services', () => {
    const date = datefns.format(new Date(), 'd MMMM yyyy')
    const getHTML = require('../../../src/templates/report/pages/filters/compliant-services/build-html')
  ...
  it('should render: pages/filters/very-high-risk-services', () => {
    const date = datefns.format(new Date(), 'd MMMM yyyy')
    const getHTML = require('../../../src/templates/report/pages/filters/very-high-risk-services/build-html')
  ...
  it('should render: pages/filters/high-risk-services', () => {
    const date = datefns.format(new Date(), 'd MMMM yyyy')
    const getHTML = require('../../../src/templates/report/pages/filters/high-risk-services/build-html')
  ...
  it('should render: pages/filters/medium-risk-services', () => {
    const date = datefns.format(new Date(), 'd MMMM yyyy')
    const getHTML = require('../../../src/templates/report/pages/filters/medium-risk-services/build-html')
  ...
  it('should render: pages/filters/unknown-risk-services', () => {
    const date = datefns.format(new Date(), 'd MMMM yyyy')
    const getHTML = require('../../../src/templates/report/pages/filters/unknown-risk-services/build-html')
  ...
  it('should render: pages/filters/critical-services', () => {
    const date = datefns.format(new Date(), 'd MMMM yyyy')
    const getHTML = require('../../../src/templates/report/pages/filters/critical-services/build-html')
  ...
  it('should render: pages/filters/sunsetting-services', () => {
    const date = datefns.format(new Date(), 'd MMMM yyyy')
    const getHTML = require('../../../src/templates/report/pages/filters/sunsetting-services/build-html')
  ...
  it('should render: pages/filters/citizen-facing-services', () => {
    const date = datefns.format(new Date(), 'd MMMM yyyy')
    const getHTML = require('../../../src/templates/report/pages/filters/citizen-facing-services/build-html')
  ...
  it('should render: pages/filters/staff-facing-services', () => {
    const date = datefns.format(new Date(), 'd MMMM yyyy')
    const getHTML = require('../../../src/templates/report/pages/filters/staff-facing-services/build-html')
