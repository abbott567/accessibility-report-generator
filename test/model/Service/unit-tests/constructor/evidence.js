...
describe('Unt: Service constructor -> service.evidence', () => {
  it('should throw an Error if params.evidence is undefined', () => {
    const params = cloneDeep(testData)
    params.orgID = 1
    params.directorateID = 1
    params.PDUID = 1
    params.evidence = undefined
    const expectedErrorMessage = `params.evidence not found when constructing Service: ${params.name}`
