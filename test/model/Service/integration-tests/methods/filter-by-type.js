...
describe('Int: Service methods -> filterByType()', () => {
  it('should return citizen facing services using filterByType(citizen)', () => {
    // Set up Org
  ...
  it('should return staff facing services using filterByType(staff)', () => {
    // Set up Org
    const orgParams = cloneDeep(testOrg)
    const org = new Org(orgParams)
    org.save()
