...
describe('Int: Directorate -> Stats -> All', () => {
  ...
  it('should generate stats.services.all.live_compliant using getServices({ risk: "compliant", status: "live" }) method', () => {
    ...
    service.save()
    // Test
    expect(directorate.stats.services.all.live_compliant).to.eql(1, 'stats.services.all.live_compliant')
    // Cleanup
    Org.all = []
    Directorate.all = []
    PDU.all = []
  ...
  it('should generate stats.services.all.live_not_compliant using getServices({ status: "live", risk: "!compliant" }) method', () => {
    ...
    service.save()
    // Test
    expect(directorate.stats.services.all.live_not_compliant).to.eql(1, 'stats.services.all.live_not_compliant')
    // Cleanup
    Org.all = []
    Directorate.all = []
    PDU.all = []
  ...
  it('should generate stats.services.all.risk_very_high using getServices({ risk: "very-high" }) method', () => {
    ...
    service.save()
    // Test
    expect(directorate.stats.services.all.risk_very_high).to.eql(1, 'stats.services.all.risk_very_high')
    // Cleanup
    Org.all = []
    Directorate.all = []
    PDU.all = []
  ...
  it('should generate stats.services.all.risk_high using getServices({ risk: "high" }) method', () => {
    ...
    service.save()
    // Test
    expect(directorate.stats.services.all.risk_high).to.eql(1, 'stats.services.all.risk_high')
    // Cleanup
    Org.all = []
    Directorate.all = []
    PDU.all = []
  ...
  it('should generate stats.services.all.risk_medium using getServices({ risk: "medium" }) method', () => {
    ...
    service.save()
    // Test
    expect(directorate.stats.services.all.risk_medium).to.eql(1, 'stats.services.all.risk_medium')
    // Cleanup
    Org.all = []
    Directorate.all = []
    PDU.all = []
  ...
  it('should generate stats.services.all.risk_low using getServices({ risk: "low" }) method', () => {
    ...
    service.save()
    // Test
    expect(directorate.stats.services.all.risk_low).to.eql(1, 'stats.services.all.risk_medium')
    // Cleanup
    Org.all = []
    Directorate.all = []
    PDU.all = []
  ...
  it('should generate stats.services.all.risk_unknown using getServices({ risk: "unknown" }) method', () => {
    ...
    service.save()
    // Test
    expect(directorate.stats.services.all.risk_unknown).to.eql(1, 'stats.services.all.risk_unknown')
    // Cleanup
    Org.all = []
    Directorate.all = []
    PDU.all = []
  ...
  it('should generate stats.services.all.critical using getServices({ critical: "true" }) method', () => {
    ...
    service.save()
    // Test
    expect(directorate.stats.services.all.critical).to.eql(1, 'stats.services.all.critical')
    // Cleanup
    Org.all = []
    Directorate.all = []
    PDU.all = []
  ...
  it('should generate stats.services.all.not_critical using getServices({ critical: "false" }) method', () => {
    ...
    service.save()
    // Test
    expect(directorate.stats.services.all.not_critical).to.eql(1, 'stats.services.all.not_critical')
    // Cleanup
    Org.all = []
    Directorate.all = []
    PDU.all = []
  ...
  it('should generate stats.services.all.sunsetting using getServices({ sunsetting: "true" }) method', () => {
    ...
    service.save()
    // Test
    expect(directorate.stats.services.all.sunsetting).to.eql(1, 'stats.services.all.sunsetting')
    // Cleanup
    Org.all = []
    Directorate.all = []
    PDU.all = []
  ...
  it('should generate stats.services.all.not_sunsetting using getServices({ sunsetting: "false" }) method', () => {
    ...
    service.save()
    // Test
    expect(directorate.stats.services.all.not_sunsetting).to.eql(1, 'stats.services.all.not_sunsetting')
    // Cleanup
    Org.all = []
    Directorate.all = []
    PDU.all = []
  ...
  it('should generate stats.services.all.plans using getServices({ plans: "true" }) method', () => {
    ...
    service.save()
    // Test
    expect(directorate.stats.services.all.plans).to.eql(1, 'stats.services.all.plans')
    // Cleanup
    Org.all = []
    Directorate.all = []
    PDU.all = []
  ...
  it('should generate stats.services.all.no_plans using getServices({ plans: "false" }) method', () => {
    ...
    service.save()
    // Test
    expect(directorate.stats.services.all.no_plans).to.eql(1, 'stats.services.all.no_plans')
    // Cleanup
    Org.all = []
    Directorate.all = []
    PDU.all = []
  ...
  it('should generate stats.services.all.live_no_plans using getServices({ status: "live", plans: "false" }) method', () => {
    ...
    service.save()
    // Test
    expect(directorate.stats.services.all.live_no_plans).to.eql(1, 'stats.services.all.live_no_plans')
    // Cleanup
    Org.all = []
    Directorate.all = []
    PDU.all = []
