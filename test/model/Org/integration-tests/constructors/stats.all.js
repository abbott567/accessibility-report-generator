...
describe('Int: Directorate -> Stats -> All', () => {
  ...
  it('should generate stats.services.all.live_compliant using getServices({ risk: "compliant", status: "live" }) method', () => {
    ...
    service.save()
    // Test
    expect(org.stats.services.all.live_compliant).to.eql(1, 'stats.services.all.live_compliant')
    // Cleanup
    Org.all = []
    Directorate.all = []
    PDU.all = []
  ...
  it('should generate stats.services.all.live_not_compliant using getServices({ status: "live", risk: "!compliant" }) method', () => {
    ...
    service.save()
    // Test
    expect(org.stats.services.all.live_not_compliant).to.eql(1, 'stats.services.all.live_not_compliant')
    // Cleanup
    Org.all = []
    Directorate.all = []
    PDU.all = []
  ...
  it('should generate stats.services.all.risk_low using getServices({ risk: "low" }) method', () => {
    ...
    service.save()
    // Test
    expect(org.stats.services.all.risk_low).to.eql(1, 'stats.services.all.risk_medium')
    // Cleanup
    Org.all = []
    Directorate.all = []
    PDU.all = []
  ...
  it('should generate stats.services.all.risk_unknown using getServices({ risk: "unknown" }) method', () => {
    ...
    service.save()
    // Test
    expect(org.stats.services.all.risk_unknown).to.eql(1, 'stats.services.all.risk_unknown')
    // Cleanup
    Org.all = []
    Directorate.all = []
    PDU.all = []
  ...
  it('should generate stats.services.all.no_plans using getServices({ plans: "false" }) method', () => {
    ...
    service.save()
    // Test
    expect(org.stats.services.all.no_plans).to.eql(1, 'stats.services.all.no_plans')
    // Cleanup
    Org.all = []
    Directorate.all = []
    PDU.all = []
  ...
  it('should generate stats.services.all.live_no_plans using getServices({ status: "live", plans: "false" }) method', () => {
    ...
    service.save()
    // Test
    expect(org.stats.services.all.live_no_plans).to.eql(1, 'stats.services.all.live_no_plans')
    // Cleanup
    Org.all = []
    Directorate.all = []
    PDU.all = []
