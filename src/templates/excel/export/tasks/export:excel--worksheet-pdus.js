...
function generatePDUsWorksheet (workbook, PDU, tabName) {
  ...
  pdus.forEach(pdu => {
    wsOverview.addRow({
      ...
      all_in_house: pdu.stats.services.all.in_house,
      all_third_party: pdu.stats.services.all.third_party,
      all_unknown_responsibility: pdu.stats.services.all.unknown_responsibility,
